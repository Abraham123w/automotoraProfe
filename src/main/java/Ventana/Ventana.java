...
public class Ventana extends JFrame implements ActionListener{
    ...
    /**
     * Genera una nueva instancia de JComboBox y establece sus coordenadas y dimensiones.
     *
     * @param datosLista Arreglo de objetos que se mostrarán en la lista desplegable.
     * @param posicionX Coordenada x de la posición de la lista desplegable.
     * @param posicionY Coordenada y de la posición de la lista desplegable.
     * @param largoX Longitud de la lista desplegable en el eje x.
     * @param largoY Longitud de la lista desplegable en el eje y.
     * @return Instancia de JComboBox creada.
     */
    protected JComboBox generarListaDesplegable(Object[] datosLista, int posicionX, int posicionY, int largoX, int largoY){
        JComboBox lista= new JComboBox(datosLista); // Crea una nueva instancia de JComboBox con los datos del arreglo.
        lista.setBounds(posicionX, posicionY, largoX, largoY); // Establece la posición y dimensiones de la lista desplegable.
        return lista; // Retorna la instancia de JComboBox creada.
    }
